...
namespace Org.BouncyCastle.Crypto.Xml
{
    public static class CryptoHelpers
    {
        ...
        private static readonly Dictionary<string, Func<object>> _knownNames = new Dictionary<string, Func<object>>()
        {
            ...
            { "http://www.w3.org/2001/04/xmldsig-more#ecdsa-sha1", () => SignerUtilities.GetSigner("SHA1WITHECDSA") },
            { "http://www.w3.org/2001/04/xmldsig-more#ecdsa-sha224", () => SignerUtilities.GetSigner("SHA224WITHECDSA") },
            { "http://www.w3.org/2001/04/xmldsig-more#ecdsa-sha256", () => SignerUtilities.GetSigner("SHA256WITHECDSA") },
            { "http://www.w3.org/2001/04/xmldsig-more#ecdsa-sha384", () => SignerUtilities.GetSigner("SHA384WITHECDSA") },
            { "http://www.w3.org/2001/04/xmldsig-more#ecdsa-sha512", () => SignerUtilities.GetSigner("SHA512WITHECDSA") },
            { "http://www.w3.org/2007/05/xmldsig-more#ecdsa-ripemd160", () => SignerUtilities.GetSigner("RIPEMD160WITHECDSA") },
