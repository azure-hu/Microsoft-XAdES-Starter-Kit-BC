...
namespace Microsoft.Xades.BC
{
    ...
    public class SignaturePolicyId
    {
        ...
        public XmlElement GetXml()
        {
            ...
            {
                throw new XadesCryptographicException("SigPolicyId element missing in SignaturePolicyId");
            }
            ...
            {
                throw new XadesCryptographicException("SigPolicyHash element missing in SignaturePolicyId");
            }
