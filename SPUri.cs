...
namespace Microsoft.Xades.BC
{
    ...
    public class SPUri : SigPolicyQualifier
    {
        ...
        public override XmlElement AnyXmlElement
        {
            ...
            set
            {
                throw new XadesCryptographicException("Setting AnyXmlElement on a SPUri is not supported");
            }
        }
        #endregion
        ...
        public override void LoadXml(System.Xml.XmlElement xmlElement)
        {
            ...
            xmlNodeList = xmlElement.SelectNodes(XadesSignedXml.XadesNamespacePrefix + ":SPURI", xmlNamespaceManager);
