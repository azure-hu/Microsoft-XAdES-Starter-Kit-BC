...
namespace Microsoft.Xades.BC
{
    ...
    public class DigestAlgAndValueType
    {
        ...
        public XmlElement GetXml()
        {
            ...
            {
                throw new XadesCryptographicException("DigestMethod element missing in DigestAlgAndValueType");
            }
            ...
            {
                throw new XadesCryptographicException("DigestValue element missing in DigestAlgAndValueType");
            }
