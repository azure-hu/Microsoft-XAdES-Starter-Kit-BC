...
namespace Microsoft.Xades.BC
{
    ...
    public class UnsignedSignatureProperties
    {
        ...
        private Boolean refsOnlyTimeStampFlag;
        ...
        /// </summary>
        public Boolean RefsOnlyTimeStampFlag
        {
            get
            {
            ...
            try
            {
                while (enumerator.MoveNext())
                {
                    ...
                    if (iterationXmlElement != null)
                    {
                        ...
                        for (Int32 childNodeCounter = 0; (childNodeCounter < iterationXmlElement.ChildNodes.Count) && (counterSignatureElement == null); childNodeCounter++)
                        {
                        ...
                        {
                            throw new XadesCryptographicException("CounterSignature element does not contain signature");
                        }
                    }
                }
            }
